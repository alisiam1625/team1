...
import 'package:team1/TinderCard.dart';

// import 'model/TinderCard.dart';

class DemoTinderHomePage extends StatefulWidget {
  static String tag = '/DemoTinderHomePage';

  @override
  _DemoTinderHomePageState createState() => _DemoTinderHomePageState();
}

class _DemoTinderHomePageState extends State<DemoTinderHomePage> {
  bool isActive = false;
